...
/**
 ...
 @return if the compression was successful or not.
 */
//+(BOOL)compressData:(NSData*)data toPath:(NSString*)toPath error:(NSError**)error;
 ...
 */
+(BOOL)decompressFileAtPath:(NSString*)filePath toPath:(NSString*)toPath error:(NSError**)error;
...
/**
 ...
 @return if the decompression was successful or not.
 */
+(BOOL)decompressData:(NSData*)data toPath:(NSString*)toPath error:(NSError**)error;
...
/**
 ...
 @return if the compression was successful or not.
 */
+(BOOL)tarFileAtPath:(NSString*)tarFilePath toPath:(NSString*)toPath error:(NSError**)error;
...
/**
 ...
 @return if the decompression was successful or not.
 */
+(BOOL)untarFileAtPath:(NSString*)tarFilePath toPath:(NSString*)toPath error:(NSError**)error;
...
/**
 ...
 @return if the compression was successful or not.
 */
//+(BOOL)tarData:(NSData*)tarData toPath:(NSString*)toPath error:(NSError**)error;
...
/**
 ...
 @return if the decompression was successful or not.
 */
+(BOOL)untarData:(NSData*)tarData toPath:(NSString*)toPath error:(NSError**)error;
